       ...
       if(mContext == null)
    	...
    	switch (errID)
    	{
			...
			case Errorno.FFMPEG_OPEN_FAILED:
				errStr = mContext.getResources().getString(R.string.open_file)+PlayList.getinstance().getcur()+mContext.getResources().getString(R.string.failed);//"Open file ( "+PlayList.getinstance().getcur()+" ) failed";
				break;	
			case  Errorno.FFMPEG_PARSE_FAILED:
				errStr = mContext.getResources().getString(R.string.parser_file)+PlayList.getinstance().getcur()+mContext.getResources().getString(R.string.failed);//"Parser file ( "+PlayList.getinstance().getcur()+" ) failed";
				break;
