...
public class playermenu extends Activity {
    ...
    private static final String ACTION_HDMISWITCH_MODE_CHANGED = "com.amlogic.HdmiSwitch.HDMISWITCH_MODE_CHANGED";
    ...
    private void videobar() {
        ...
        resume.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                 ...
                 * la.setSelectItem(SettingsVP.getParaBoolean("ResumeMode") ? 0
                 * : 1); listView.setAdapter(la);
                 */
        ...
        if (playmode_switch) {
            playmode.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                     ...
                     * playermenu.this.getResources
                     * ().getString(R.string.setting_playmode_repeatone) };
                     * 
                     * MyListAdapter la = new
                     * MyListAdapter<String>(playermenu.this, R.layout.list_row,
                     * m_repeat); la.setSelectItem(m_playmode - 1);
        ...
        audiotrack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                ListView listView = (ListView) findViewById(R.id.AudioListView);
                /*
                 * if (AudioTrackOperation.AudioStreamFormat.size() <
                 * bMediaInfo.getAudioTrackCount())
                 * AudioTrackOperation.setAudioStream(bMediaInfo); MyListAdapter
                 * la = new MyListAdapter<String>(playermenu.this,
                 * R.layout.list_row, AudioTrackOperation.AudioStreamFormat);
                 * la.setSelectItem(cur_audio_stream); listView.setAdapter(la);
                 */
                ...
                Bswitch_l.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        if (sub_switch_state == sub_para.totalnum)
                            ...
                            t_subswitch.setText(String.valueOf(sub_switch_state + 1)
                                + "/" + String.valueOf(sub_para.totalnum));
                    }
                });
        ...
        display.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                 ...
                 * playermenu.this.getResources
                 * ().getString(R.string.setting_displaymode_fullscreen), "4:3",
                 * "16:9", playermenu.this.getResources().getString(R.string.
                 * setting_displaymode_normal_noscaleup), }; MyListAdapter la =
                 * new MyListAdapter<String>(playermenu.this, R.layout.list_row,
                 * m_display); la.setSelectItem(ScreenMode.getScreenMode());
                 * listView.setAdapter(la);
                 */
        ...
        brigtness.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                int mBrightness = 0;
                try {
                    mBrightness = Settings.System.getInt(playermenu.this.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS);
                ...
                /*
                 * MyListAdapter la = new MyListAdapter<String>(playermenu.this,
                 * R.layout.list_row, m_brightness); la.setSelectItem(item);
                 * listView.setAdapter(la);
                 */
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        try {
                            ...
                            if (power != null) {
                                ...
                                Settings.System.putInt(playermenu.this.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS, brightness);
                            }
        ...
        fileinformation.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                /*
                 * String fileinf =
                 * playermenu.this.getResources().getString(R.string
                 * .str_file_name) + "\t: " +
                 ...
                 * playermenu.this
                 * .getResources().getString(R.string.str_file_size) + "\t: " +
                 * bMediaInfo.getFileSize() + "\n" +
                 * playermenu.this.getResources
                 * ().getString(R.string.str_file_resolution) + "\t: " +
                 * bMediaInfo.getResolution() + "\n" +
                 * playermenu.this.getResources
                 * ().getString(R.string.str_file_duration) + "\t: " +
                 * secToTime(bMediaInfo.duration, true) + "\n" ; AlertDialog fi
                 * = new AlertDialog.Builder(playermenu.this)
                 * .setTitle(R.string.str_file_information) .setMessage(fileinf)
                 * .setPositiveButton(R.string.str_ok, new
                 * DialogInterface.OnClickListener() { public void
                 * onClick(DialogInterface dialog, int whichButton) {
                 * dialog.dismiss(); morbar.setVisibility(View.VISIBLE); } })
                 * .show();
                 */
    ...
    public boolean onKeyDown(int keyCode, KeyEvent msg) {
        ...
        if (keyCode == KeyEvent.KEYCODE_UNKNOWN) {
            ...
            if (morbar != null) {
                ...
                // close sub
                /*
                 * if(subTitleView!=null) subTitleView.closeSubtitle(); //stop
                 * play backToFileList = true; Amplayer_stop();
                 */
        ...
        } else if (keyCode == KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE)// play or pause
        {
            ...
            return (true);
        } else if (keyCode == KeyEvent.KEYCODE_MEDIA_PREVIOUS)// play previous
                                                              // movie
        {
            // TODO Auto-generated method stub
            if (!INITOK)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * WindowManager wm = getWindowManager(); Display display =
         * wm.getDefaultDisplay(); int hei = display.getHeight(); int wid =
         * display.getWidth(); Log.d(TAG,
         * ".....display.getHeight:"+hei+".....display.getWidth:"+wid);
         */
        ...
        IntentFilter intentFilter = new IntentFilter(
            ACTION_HDMISWITCH_MODE_CHANGED);
                    ...
                    case 0x3d:
                        if (confirm_dialog.isShowing()) {
                            if (resumeSecond > 0) {
                                ...
                                confirm_dialog.getButton(AlertDialog.BUTTON_NEGATIVE).setText(cancel
                                    + " ( " + (--resumeSecond) + " )");
                                ResumeCountdown();
                            } else {
                                playPosition = 0;
                                /*
                                 * if (!NOT_FIRSTTIME) StartPlayerService();
                                 * else Amplayer_play();
                                 */
            ...
            switch (msg.what) {
                case VideoInfo.TIME_INFO_MSG:
                    ...
                    if (totaltime == 0)
                        ...
                        if (!progressSliding)
                            myProgressBar.setProgress(msg.arg1 / 1000 * 100
                                / totaltime);
                    }
                    break;
                case VideoInfo.STATUS_CHANGED_INFO_MSG:
                    ...
                    switch (player_status) {
                        ...
                        case VideoInfo.PLAYER_STOPED:
                            /*
                             * new PlayThread().start(); if (PRE_NEXT_FLAG == 1)
                             * { Log.d(TAG,"to play another file!");
                             * //Amplayer_play(); PRE_NEXT_FLAG = 0; }
                             */
                            break;
                        ...
                        case VideoInfo.PLAYER_ERROR:
                            ...
                            Toast.makeText(playermenu.this, "Status Error:"
                                + InfoStr, Toast.LENGTH_LONG).show();
                        ...
                        case VideoInfo.PLAYER_INITOK:
                            ...
                            sub_para.totalnum = subMange.getExSubTotal()
                        ...
                        case VideoInfo.DIVX_AUTHOR_ERR:
                            ...
                            try {
                                ...
                                new AlertDialog.Builder(playermenu.this).setTitle("Authorization Error").setMessage("This player is not authorized to play this DivX protected video").setPositiveButton(R.string.str_ok, new DialogInterface.OnClickListener() {
                        ...
                        case VideoInfo.DIVX_EXPIRED:
                            ...
                            try {
                                ...
                                String s = "This rental has "
                                    ...
                                    + msg.arg2 + " views now";
                                new AlertDialog.Builder(playermenu.this).setTitle("View DivX(R) VOD Rental").setMessage(s).setPositiveButton(R.string.str_ok, new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                        int whichButton) {
                                        Intent selectFileIntent = new Intent();
                                        selectFileIntent.setClass(playermenu.this, FileList.class);
                ...
                case VideoInfo.HAS_ERROR_MSG:
                    ...
                    Toast.makeText(playermenu.this, errStr, Toast.LENGTH_LONG).show();
                    break;
                default:
                    super.handleMessage(msg);
                    break;
    ...
    private void Amplayer_play() {
        ...
        /*
         * try { m_Amplayer.Play(); } catch(RemoteException e) {
         * e.printStackTrace(); }
         */
    }
    ...
    public void StartPlayerService() {
        Intent intent = new Intent();
        ComponentName hcomponet = new ComponentName("com.farcore.videoplayer",
            "com.farcore.playerservice.AmPlayer");
    ...
    private int resumePlay() {
        ...
        if (pos > 0) {
            confirm_dialog = new AlertDialog.Builder(this).setTitle(R.string.setting_resume).setMessage(R.string.str_resume_play).setPositiveButton(R.string.str_ok, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                    playPosition = pos;
                }
            }).setNegativeButton(playermenu.this.getResources().getString(R.string.str_cancel)
                + " ( " + resumeSecond + " )", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                    playPosition = 0;
                }
            }).show();
    ...
    private final StorageEventListener mListener = new StorageEventListener() {
        ...
        public void onStorageStateChanged(String path, String oldState,
            String newState) {
            // Log.d(TAG,
            // "..............onStorageStateChanged...................."+path+newState);
            if (newState == null || path == null)
                return;

            if (newState.compareTo("unmounted") == 0
